...
///////////////////////////////////////////////////////////////////////////////////////////////////////
//  TelegramBot - это класс, который описывает логику бота, в наследованном onUpdateReceived методе  //
//  от класса родителя TelegramLongPollingBot мы пишем поведение, которое происходит при обновлении  //
//                  чата с пользователем, так же в методе обработки сообщений есть вызов             //
//                                  нашего producer и записьданных в БД                              //
///////////////////////////////////////////////////////////////////////////////////////////////////////
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    public void onUpdateReceived(Update request) {
        ...
        /*
         * Это фрагмент с отправкой в Kafka
         * и записью в БД
         */
